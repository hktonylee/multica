...
mkdir -p "$runtime_home/.multica" "$runtime_home/.codex" "$runtime_home/.local/bin" /usr/local/lib/node_modules /work
chown -R "$runtime_user:$runtime_user" "$runtime_home/.multica" "$runtime_home/.codex" "$runtime_home/.local" /usr/local/lib/node_modules /work
